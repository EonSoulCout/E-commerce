...
<body style="background-image: url('images/router_conenct.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">

    <header>
        <div class="header-content">
            <h1>Bienvenido al Dashboard de Empleado</h1>
